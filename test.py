...
@description:  Programa de pruebas para crear usuarios, encriptar sus contraseñas
ADVERTENCIA: no corra este programa en produccion, ya que solo son pruebas y genera llaves aleatorias y usuarios nuevos
